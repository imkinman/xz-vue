<template>
    <div id="myBody" class="nav-md">
        <div class="container body">
            <div class="main_container">
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="index.html" class="site_title"><img src="../assets/img/icon.png" class="logo">&nbsp;&nbsp;<span>学子商城后台</span></a>
                        </div>
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <ul class="nav child_menu">
                                    ...
                                    <li>
                                        <router-link to="./ProductAdd">添加商品</router-link>
                                    </li>
                                </ul>
                                </li>
    ...
    export default{
        ...
        methods:{
            ...
            init_sidebar() {
                ...
                this.$SIDEBAR_MENU.find('a').filter((a)=>{
                    return a.href == this.CURRENT_URL;
